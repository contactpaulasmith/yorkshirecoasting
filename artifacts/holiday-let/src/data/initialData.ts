...
export interface ThingToDo {
  id: string;
  title: string;
  category: "Food & Drink" | "Beaches" | "Attractions" | "Shopping" | "Children" | "Transport" | "Walks";
  location: string;
  description: string;
  image: string;
  link: string;
...
export const initialThingsToDo: ThingToDo[] = [
  ...
  { id: "t34", title: "Cleveland Way: Scarborough to Filey", category: "Walks", location: "Scarborough to Filey, North Yorkshire", description: "The final and most beautiful section of the Cleveland Way National Trail. From Scarborough the route hugs the clifftops all the way to the dramatic headland of Filey Brigg, with only a short inland detour at Osgodby. Expect breathtaking sea views, golden bays and a real sense of achievement at the finish. 10.5 miles | 4 hours | Moderate.", image: "https://images.unsplash.com/photo-1660208605985-a307cecca11b?w=800&q=80", link: "https://www.thewalkingdiary.co.uk/walks/cleveland-way-scarborough-to-filey/", propertyIds: ["p1", "p2"] },
  { id: "t35", title: "Cleveland Way: Scarborough to Robin Hood's Bay", category: "Walks", location: "Scarborough to Robin Hood's Bay, North Yorkshire", description: "A spectacular stretch of the Cleveland Way heading north from Scarborough along the dramatic North Yorkshire coastline to the iconic fishing village of Robin Hood's Bay. The route takes in soaring clifftops, hidden coves and sweeping sea views, with a handful of steep ascents adding to the sense of adventure. 14 miles | 5.5 hours | Moderate.", image: "https://images.unsplash.com/photo-1555795622-fa8fd9fe33a1?w=800&q=80", link: "https://www.thewalkingdiary.co.uk/walks/cleveland-way-day-7-robin-hoods-bay-to-scarborough/", propertyIds: ["p1", "p2"] }
];
