...
export const initialThingsToDo: ThingToDo[] = [
  ...
  { id: "t25", title: "Nippy Taxis", category: "Transport", location: "Scarborough", description: "A reliable local taxi service covering Scarborough and the surrounding area. Available for airport transfers, days out, and getting around town.", image: "https://r.bing.com/rp/sjf350zBBjP4sf6OJkvVEP78mas.png", link: "#", propertyIds: ["p1", "p2"] },
  { id: "t26", title: "Boro Taxis", category: "Transport", location: "Scarborough", description: "One of Scarborough's established taxi firms, offering prompt and friendly service for local journeys, transfers, and longer trips across North Yorkshire.", image: "https://r.bing.com/rp/sjf350zBBjP4sf6OJkvVEP78mas.png", link: "#", propertyIds: ["p1", "p2"] },
  { id: "t27", title: "Beeline Taxis", category: "Transport", location: "Scarborough", description: "A trusted Scarborough taxi company providing a dependable service for all your travel needs, from short hops to airport runs across Yorkshire.", image: "https://r.bing.com/rp/sjf350zBBjP4sf6OJkvVEP78mas.png", link: "#", propertyIds: ["p1", "p2"] }
];
