...
export const initialThingsToDo: ThingToDo[] = [
  ...
  { id: "t25", title: "Nippy Taxis", category: "Transport", location: "Scarborough", description: "A reliable local taxi service covering Scarborough and the surrounding area. Available for airport transfers, days out, and getting around town.", image: "https://images.unsplash.com/photo-1559829604-cb2f6826ad91?w=600&q=80", link: "#", propertyIds: ["p1", "p2"] },
  { id: "t26", title: "Boro Taxis", category: "Transport", location: "Scarborough", description: "One of Scarborough's established taxi firms, offering prompt and friendly service for local journeys, transfers, and longer trips across North Yorkshire.", image: "https://images.unsplash.com/photo-1559829604-cb2f6826ad91?w=600&q=80", link: "#", propertyIds: ["p1", "p2"] },
  { id: "t27", title: "Beeline Taxis", category: "Transport", location: "Scarborough", description: "A trusted Scarborough taxi company providing a dependable service for all your travel needs, from short hops to airport runs across Yorkshire.", image: "https://images.unsplash.com/photo-1559829604-cb2f6826ad91?w=600&q=80", link: "#", propertyIds: ["p1", "p2"] }
];
