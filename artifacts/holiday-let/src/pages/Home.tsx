    ...
    <Layout>
      ...
      <section className="relative h-[85vh] min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center text-white px-4 max-w-4xl mx-auto">
          ...
          >
            <strong>Book direct</strong> for the best rates on luxury holiday accommodation on the Yorkshire Coast.
          </motion.p>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={fadeIn}>
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              The fresh bed linen is pressed, the wine glasses polished and the cushions plumped. All that's left to do is sit back and unwind, knowing every little detail has been considered. It's more than holidaying. It's Yorkshire Coasting.
            </p>
          </motion.div>
        </div>
      </section>
